...
/** 홈 화면 — 이어하기 + 추천 + 행성 위젯을 한 번에 조립한다(홈-01~05). */
public record HomeResponse(
    ...
    /** hasUnacknowledged가 true면 행성 진입 전에 연출 예고 점을 표시한다(보상-08). */
    public record PlanetWidget(int stardustBalance, int placedCount, boolean hasUnacknowledged) {}
}
