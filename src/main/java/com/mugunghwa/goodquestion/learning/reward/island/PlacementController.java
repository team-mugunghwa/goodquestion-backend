...
import com.mugunghwa.goodquestion.learning.reward.island.dto.PlacementCreateRequest;
import com.mugunghwa.goodquestion.learning.reward.island.dto.PlacementMoveRequest;
import com.mugunghwa.goodquestion.learning.reward.island.dto.PlacementResponse;
 ...
 * TODO: Island·IslandItem 엔티티와 서비스 구현.
 */
@RestController
@RequiredArgsConstructor
public class PlacementController {

    @PostMapping("/api/children/{childId}/island/placements")
    ...
    @PatchMapping("/api/island/placements/{placementId}")
    ...
    @DeleteMapping("/api/island/placements/{placementId}")
