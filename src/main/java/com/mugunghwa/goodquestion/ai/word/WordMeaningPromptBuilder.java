...
public class WordMeaningPromptBuilder {
    ...
    public String buildSystemPrompt() {
        return """
                ...
                규칙:
                1) meaning은 **20자를 넘지 않는** 짧은 한 문장이다. 쓰고 나서 글자 수를 세어
                   보고, 넘으면 군더더기를 덜어 다시 쓴다. 아래 예시만큼 짧게 쓴다.
                     기왓장 -> 지붕을 덮는 납작한 조각이에요   (15자)
                     두레박 -> 우물에서 물을 뜨는 그릇이에요   (15자)
                     이장   -> 마을 일을 돌보는 사람이에요     (14자)
                   덧붙이지 않는다: 재료 설명("무쇠나 흙으로 만든"), 시대 설명("옛날에"),
                   용도 나열("데우거나 놓는"). 하나만 골라 쓴다.
        ...
        return Map.of(
                ...
                "properties", Map.of(
                        "meaning", Map.of("type", "string",
                                "description", "20자 이하, -이에요/-해요체로 끝나고 마침표가 없는 쉬운 우리말 뜻풀이"),
