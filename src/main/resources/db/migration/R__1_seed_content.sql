...
('44444444-4444-4444-4444-000000000003', '납작 돌', 'TERRAIN_PROP', 0, 'ALWAYS', null, null, '/items/models/rock_smallFlatA.glb', null, 2),
('44444444-4444-4444-4444-000000000004', '조약돌', 'TERRAIN_PROP', 0, 'ALWAYS', null, null, '/items/models/stone_smallG.glb', null, 3),
('44444444-4444-4444-4444-000000000005', '돌무더기', 'TERRAIN_PROP', 0, 'ALWAYS', null, null, '/items/models/forest/stones.glb', null, 4),
('44444444-4444-4444-4444-000000000006', '통나무', 'TERRAIN_PROP', 0, 'ALWAYS', null, null, '/items/models/log.glb', null, 5),
('44444444-4444-4444-4444-000000000008', '장작더미', 'TERRAIN_PROP', 0, 'ALWAYS', null, null, '/items/models/log_stack.glb', null, 6),
('44444444-4444-4444-4444-000000000009', '돌길', 'TERRAIN_PROP', 0, 'ALWAYS', null, null, '/items/models/path_stone.glb', null, 7),
('44444444-4444-4444-4444-000000000002', '풀', 'PLANT', 0, 'ALWAYS', null, null, '/items/models/grass_large.glb', null, 8),
('44444444-4444-4444-4444-00000000000a', '잔디밭', 'PLANT', 0, 'ALWAYS', null, null, '/items/models/forest/patch-grass.glb', null, 9),
('44444444-4444-4444-4444-00000000000b', '빨간 꽃', 'PLANT', 0, 'ALWAYS', null, null, '/items/models/flower_redA.glb', null, 10),
('44444444-4444-4444-4444-00000000000c', '노란 꽃', 'PLANT', 0, 'ALWAYS', null, null, '/items/models/flower_yellowA.glb', null, 11),
('aef875b6-9c7a-5d41-8724-f4715b13ae58', '버섯', 'PLANT', 0, 'ALWAYS', null, null, '/items/models/mushroom_redGroup.glb', null, 12),
('b1abdfdc-6565-5fc6-975d-12732df2663b', '덤불', 'PLANT', 0, 'ALWAYS', null, null, '/items/models/plant_bushDetailed.glb', null, 13),
('44444444-4444-4444-4444-000000000007', '작은 나무', 'PLANT', 0, 'ALWAYS', null, null, '/items/models/forest/plant.glb', null, 14),
...
('c315deea-a319-5dac-abc2-5ced933d8486', '참나무', 'STRUCTURE', 0, 'ALWAYS', null, null, '/items/models/nature/tree_oak.glb', null, 27),
('858c7f62-bd62-51a4-b5f5-f8a32d7263a1', '소나무', 'STRUCTURE', 0, 'ALWAYS', null, null, '/items/models/nature/tree_pineRoundC.glb', null, 28),
('89ad73a7-ed3d-5b8b-90ea-4e3dfcdd434d', '야자수', 'STRUCTURE', 0, 'ALWAYS', null, null, '/items/models/nature/tree_palmDetailedTall.glb', null, 29),
('a26ac50e-94cc-5445-9fed-4f1cf2991a4b', '단풍나무', 'STRUCTURE', 0, 'ALWAYS', null, null, '/items/models/nature/tree_default_fall.glb', null, 30),
('9e6b0b25-015e-59e1-a914-f4b9194d6346', '갈색 버섯', 'PLANT', 0, 'ALWAYS', null, null, '/items/models/nature/mushroom_tanGroup.glb', null, 31),
('32239f1f-1f3c-501c-8c68-025366b56d9a', '선인장', 'PLANT', 0, 'ALWAYS', null, null, '/items/models/nature/cactus_tall.glb', null, 32),
('914b3629-c913-54c1-a65d-dd7240334327', '나무 그루터기', 'TERRAIN_PROP', 0, 'ALWAYS', null, null, '/items/models/nature/stump_roundDetailed.glb', null, 33),
...
('44444444-4444-4444-4444-000000000046', '무궁화나무', 'PLANT', 0, 'ALWAYS', null, null, '/items/models/gift/mugunghwa_tree.glb', null, 46),
('44444444-4444-4444-4444-000000000047', '생일 케이크', 'STRUCTURE', 0, 'ALWAYS', null, null, '/items/models/gift/birthday_cake.glb', null, 47),
('44444444-4444-4444-4444-000000000048', '졸업 축하', 'STRUCTURE', 0, 'ALWAYS', null, null, '/items/models/gift/graduation_cap.glb', null, 48)
on conflict (id) do update set
    name = excluded.name,
